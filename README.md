...
| `EMAIL_DOMAIN` | Доменное имя организации в Yandex 360 (для подстановки в письма) | Нет | `example.ru` |

> [!NOTE]
> **Важно о SMTP-параметрах:**
> - Для отправки писем можно использовать учетную запись пользователя из вашей организации Yandex 360.
